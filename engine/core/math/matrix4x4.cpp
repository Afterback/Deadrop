...
Matrix4x4::Matrix4x4(float m00, float m11, float m22, float m33)
{
    // first row
...
Matrix4x4 Matrix4x4::operator *(const Matrix4x4& param)
{
    Matrix4x4 temp = {};
    for (size_t i = 0; i < 4; i++)
    {
...
float& Matrix4x4::operator ()(size_t i, size_t j)
{
